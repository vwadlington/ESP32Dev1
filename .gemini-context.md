...
dlogger.c: Contains LVGL-specific debug prints (printf("[DLOGGER] LVGL Log: ..."))

app_bridge.c: Directly manipulates LVGL table (lv_table_set_cell_value())

Missing separation: UI layer accesses data layer directly in some paths

Circular dependencies: Components include headers from wrong layers
